...
class Transacao{
    ...
    static transferencia (contaOrigem,contaDestino,idTransacao,dataDeTransacao,valorDaTransferencia){
            ...
            if(contaOrigem.saldo >= valorDaTransferencia){
                ...
                let dadosTransferenciaContaOrigem = {
                ...
                contaOrigem.historico.push(dadosTransferenciaContaOrigem); 

                let dadosTransferenciaContaDestino = {
                    idTransacao: idTransacao,
                    dataDeTransacao: dataDeTransacao,
                    valorDaTransferencia: valorDaTransferencia,
                    tipo: "recebimento",
                ...
                contaDestino.historico.push(dadosTransferenciaContaDestino);
    ...
    static deposito(contaDestino,idDeposito,dataDoDeposito,valorDoDeposito){
        ...
        contaDestino.historico.push(dadosDepositoContaDestino);
    ...
    static pagamentoSalario(contaOrigem,contaDestino,idPagamento,dataDoPagamento,valorDoSalario){
        ...
        let dadosPagamentoContaDestino = {
        ...
        contaDestino.historico.push(dadosPagamentoContaDestino);

        let dadosPagamentoContaOrigem = {
            idPagamento: idPagamento,
            dataDoPagamento: dataDoPagamento,
            valorDoSalario: valorDoSalario,
            tipo: "pagamento"
        ...
        contaOrigem.historico.push(dadosPagamentoContaOrigem)
